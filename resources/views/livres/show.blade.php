                    ...
                    <section class="content invoice">
                        ...
                        <div class="row">
                            <div class="col-xs-12 invoice-header">
                                <h1>
                                    <i class="fa fa-book"></i> {{$livre->titre_propre}}
                                    <small class="pull-right">Date: {{$livre->created_at}}</small>
                                </h1>
                            </div>
                            <!-- /.col -->
                        </div>
                        ...
                        <div class="row invoice-info">
                            <div class="col-sm-4 invoice-col">
                                ...
                                <address>
                                    ...
                                    <b>ISBN:</b> {{$livre->isbn}}
                                    <br>
                                    <b>Edition:</b> {{$livre->edition}}
                                    <br>
                                    <b>Année:</b> {{$livre->annee_edition}}
                                    <br>
                                    <b>Prix:</b> {{$livre->prix}} DH
                                    <br>
                                    <b>langue:</b> {{$livre->langue}}
                                </address>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-4 invoice-col">
                            ...
                            <div class="col-xs-12 table">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @if (count($livre->exemplaires->all())>0)
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                {!! Form::open(['url' => 'livre/exemplaire/','method'=>'DELETE' ,'id'=>'deletForm','class'=>'form-horizontal form-label-left']) !!}
                    <div class="modal-body">
                        <h1>vasdjhas dasjkdas daksda </h1>
                        <input type="hidden" name="idLivre" value="{{$livre->id}}" id="inputidLivre">
                    </div>
