                        ...
                        @foreach($enseignants as $enseignant)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('enseignant.edit',$enseignant->id)}}" class="btn  btn-info"><li class="glyphicon glyphicon-pencil"></li> </a>
                                    <button idprof="{{$enseignant->id}}" type="button" class="btn btn-danger deleteEn" data-toggle="modal" data-target=".bs-example-modal-lg"><li class="glyphicon glyphicon-remove"></li></button>
