        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    {!! Form::model($these,['route' => array('these.update', $these->id),'method'=>'PUT','class'=>'form-horizontal form-label-left']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::text('nom', null,['class' => 'form-control col-md-7 col-xs-12']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!!  Form::label('edition', 'Edition *', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::text('these_genre', null,['class' => 'form-control col-md-7 col-xs-12']) !!}
                        </div>
                    </div>
