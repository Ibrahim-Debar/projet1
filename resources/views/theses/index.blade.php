                        ...
                        @foreach($theses as $these)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @foreach($these->Auteurs->all() as $auteur)
                                ...
                                <td>
                                    ...
                                    <button idprof="{{$these->id}}" type="button" class="btn btn-danger deleteEn" data-toggle="modal" data-target=".bs-example-modal-lg"><li class="glyphicon glyphicon-remove"></li></button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
